...
def top_artists(limit=6):
    url = "https://spotify-scraper.p.rapidapi.com/v1/chart/artists/top"

    headers = {
        "x-rapidapi-key": "4cd042bce5mshbf79cb0b2022cccp189c45jsnc642d648de65",
    ...
    if 'artists' in response_data:
        ...
        for i, artist in enumerate(response_data['artists']):
            if i >= limit:
                break
    ...
    MSP = MSP_data['artist']
    artists_info.insert(0, (MSP['name'], MSP['headerUrl'], MSP['id']))
